...
folder_path_driver_level = "/group/siv3/staff/andreis/sibridge/yashl/VCU2/python_script_for_TC/yash_python_scripting/for_test/Enc_Multistream/Output_32/32_streams_480p30_resolution"
    ...
    if extract_feature_flag == 1:
      #  print("extract_feature condition true")
        ...
        if feature_folder == "Output/32_streams_mix_resolution":
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_32/32_streams_mix_resolution"
        elif feature_folder == "Output/32_streams_480p30_resolution":
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_32/32_streams_480p30_resolution"
        elif feature_folder == "Output/8_streams_1080p30_resolution_1":
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_8/8_streams_1080p30_resolution_1"
        elif feature_folder == "Output/8_streams_1080p30_resolution_2":
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_8/8_streams_1080p30_resolution_2"
        elif feature_folder == "Output/8_streams_1080p30_resolution_3":
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_8/8_streams_1080p30_resolution_3"
        elif feature_folder == "Output/8_streams_1080p30_resolution_4":
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_8/8_streams_1080p30_resolution_4"
        elif feature_folder in stream_4:
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_4"
        elif feature_folder in stream_2:
            folder_path_multistream = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Multistream/Output_2"
        else:
