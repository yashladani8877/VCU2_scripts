...
#Path of Latency Mode
folder_path_low_latency = "/everest/ssw_multimedia_bkup/VCU2/regression_logs/Encoder/Parameters/Output"
#Path of XAVC decoder
folder_path_xavc = "/build/ssw_vcu/common_data/xavc_mxf_file_decoder/mxf_files/"
...
#--------------------------------------------------------------------------------------------------------------------    
    ...
    if sheet_option == "Dec_Driver_level":
        ...
        for root, dirs, files in os.walk(final_bitstream_path):
            if bitstream_file in files:
                ...
                file_path = None
    if sheet_option == "XAVC":
        file_path = folder_path_xavc + bitstream_file
        print(file_path)
   ...
   #         print("###Bitdepth", bitdepth_value)
        ...
        if sheet_option == "XAVC":
            if bitdepth_value == "10":
                command = "./AL_Decoder.exe -avc -in " + str(file_path) + " --md5 " + log_folder + "/" + cell.value + "/" + cell.value + ".md5" + " -bd 10" + " -noyuv"
            else:
                command = "./AL_Decoder.exe -avc -in " + str(file_path) + " --md5 " + log_folder + "/" + cell.value + "/" + cell.value + ".md5" + " -noyuv"
     ...
     #               print(f'MD5sum: {md5sum_output}')
            ...
            if bitdepth_value == "10":
                if codec_value == "AVC":
                    if latency_flag:
                        command = "./AL_Decoder.exe -avc -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 10" + " -lowlat"
                    else:
                        command = "./AL_Decoder.exe -avc -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 10"
                    ...
                    if latency_flag:
                        command = "./AL_Decoder.exe -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 10" + " -lowlat"
                    else:
                        command = "./AL_Decoder.exe -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 10"
            elif bitdepth_value == "12":
                if codec_value == "AVC":
                    if latency_flag:
                        command = "./AL_Decoder.exe -avc -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 12" + " -lowlat"
                    else:
                    ...
                    if latency_flag:
                        command = "./AL_Decoder.exe -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 12" + " -lowlat"
                    else:
                        command = "./AL_Decoder.exe -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 12"
            else:
                if codec_value == "AVC":
                    if latency_flag:
                        command = "./AL_Decoder.exe -avc -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 8" + " -lowlat"
                    else:
                        command = "./AL_Decoder.exe -avc -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 8"
                elif codec_value == "MJPEG":
                    ...
                    if latency_flag:
                        command = "./AL_Decoder.exe -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 8" + " -lowlat"
                    else:
                        command = "./AL_Decoder.exe -in " + str(file_path) + " -out " + log_folder + "/" + cell.value + "/" + cell.value + ".yuv" + " -bd 8"
...
#                break
    ...
    if sheet_option == "Dec_Conformance" or sheet_option == "XAVC":
        md5sum_file = log_folder + "/" + cell.value + "/" + str(parameters[0].split("=")[1]) + "_md5sum.txt"
        md5sum_file_xavc = log_folder + "/" + cell.value + "/" + str(parameters[0].split("=")[1]) + ".md5"
        md5sum_file = md5sum_file.replace(" ","")
        md5sum_file_xavc = md5sum_file_xavc.replace(" ","")
        print(md5sum_file_xavc)
        if sheet_option == "XAVC":
            try:
                with open(md5sum_file_xavc, 'r', encoding='utf-8') as file:
  ...
  #             print(hw_md5_contents)
    ...
    if sheet_option == "Dec_Conformance" or sheet_option == "Dec_Driver_level" or sheet_option == "Latency_mode" or sheet_option == "XAVC":
        try:
