...
folder_path_driver_level = "/mnt/group/siv3/staff/andreis/sibridge/yashl/VCU2/regression/Decoder/Color_Format"
#Path of XAVC decoder
folder_path_xavc = "/mnt/build/ssw_vcu/common_data/xavc_mxf_file_decoder/mxf_files/"
...
#--------------------------------------------------------------------------------------------------------------------    
   ...
   # print(filtered_list)
    ...
    if sheet_option == "Dec_Driver_level":
        if codec_value == 'MJPEG':
            final_bitstream_path = '/mnt/everest/ssw_multimedia_bkup/VCU2/MJPEG_StreamFile/ffmpeg_encoded'
        else:
   ...
   #         print("###Bitdepth", bitdepth_value)
        ...
        if sheet_option == "XAVC":
            if bitdepth_value == "10":
                command = "ctrlsw_decoder --embedded --device /dev/al_d3xx -avc -in " + str(file_path) + " --md5 " + log_folder + "/" + cell.value + "/" + cell.value + ".md5" + " -bd 10" + " -noyuv"
            else:
                command = "ctrlsw_decoder --embedded --device /dev/al_d3xx -avc -in " + str(file_path) + " --md5 " + log_folder + "/" + cell.value + "/" + cell.value + ".md5" + " -noyuv"
...
#                break
  ...
  #             print(hw_md5_contents)
    ...
    if sheet_option == "Dec_Conformance" or sheet_option == "Dec_Driver_level" or sheet_option == "XAVC":
        try:
